    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          ...
          {/* Demo Video — right below CTA buttons */}
          <motion.div
            id="demo"
            initial="hidden"
            animate="visible"
      ...
      <section id="features" className="py-24 bg-slate-50 scroll-mt-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <div className="w-12 h-12 rounded-xl bg-blue-600 flex items-center justify-center mb-5 shadow-lg shadow-blue-600/20">
            ...
            <motion.div
              ...
              className="group relative bg-white rounded-2xl border border-slate-200 p-8 hover:border-slate-300 hover:shadow-lg hover:shadow-slate-200/50 transition-all"
            >
              <div className="w-12 h-12 rounded-xl bg-violet-600 flex items-center justify-center mb-5 shadow-lg shadow-violet-600/20">
            ...
            <motion.div
              ...
              className="group relative bg-white rounded-2xl border border-slate-200 p-8 hover:border-slate-300 hover:shadow-lg hover:shadow-slate-200/50 transition-all"
            >
              <div className="w-12 h-12 rounded-xl bg-emerald-600 flex items-center justify-center mb-5 shadow-lg shadow-emerald-600/20">
            ...
            <motion.div
              ...
              className="group relative bg-white rounded-2xl border border-slate-200 p-8 hover:border-slate-300 hover:shadow-lg hover:shadow-slate-200/50 transition-all"
            >
              <div className="w-12 h-12 rounded-xl bg-amber-600 flex items-center justify-center mb-5 shadow-lg shadow-amber-600/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                title: "Intelligence",
                description:
                  "Fully instrumented? Probe becomes your decision partner — no more detective work across a dozen tools. It surfaces the insights so you can apply your product taste to what actually matters.",
                icon: Brain,
              ...
              return (
                <motion.div
                  ...
                  className="relative"
                >
                  <span className="text-6xl font-black text-slate-300 absolute -top-2 -left-1">
                    {stage.step}
                  </span>
      ...
      {/* Integrations + Product Visual — moved below differentiator */}
      <section id="integrations" className="py-20 bg-slate-50 border-t border-slate-100 scroll-mt-20">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute -inset-4 bg-gradient-to-t from-slate-50 via-transparent to-transparent z-10 pointer-events-none" />
