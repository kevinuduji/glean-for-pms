...
const mockDiscoverItems: DiscoverItem[] = [
  {
    ...
    description: "I found a search feature in your codebase (src/components/SearchBar.tsx) but no analytics events tracking search queries, result counts, or click-throughs. Tracking these could reveal what users are looking for and whether they're finding it.",
    priority: "high",
  ...
  },
  {
    ...
    description: "Your app has error boundaries in 3 routes (src/app/dashboard, src/app/settings, src/app/checkout) but none of them emit events when users hit errors or retry. Without this, you can't measure how often users encounter failures or how they recover.",
    priority: "high",
    source: "GitHub Code Analysis",
    impact: 0,
    confidence: 91,
  ...
  },
  {
    ...
    description: "API errors causing 23% of checkout attempts to fail. Revenue impact estimated at $12K/day.",
    priority: "critical",
  ...
  },
  {
    ...
    description: "Support tickets about 'slow loading' increased 340% in the last 24 hours.",
    priority: "critical",
  ...
  },
  {
    ...
    description: "Mobile traffic increased 47% this week. Desktop conversion rates are 2x higher - opportunity to optimize mobile experience.",
    priority: "high",
    source: "Amplitude",
    impact: 2400,
    timestamp: "1 day ago",
  ...
  },
  {
    ...
    description: "Similar companies saw 15% conversion lift by adding testimonials. Your signup page has no social proof elements.",
    priority: "high",
    source: "AI Analysis",
    impact: 600,
    confidence: 87,
  ...
  },
  {
    ...
    description: "Users spending 3.2x longer on pricing page with high bounce rate. Session recordings show confusion around feature comparisons.",
    priority: "medium",
    source: "PostHog",
    impact: 320,
  ...
  },
  {
    ...
    description: "67% of users don't complete onboarding. A/B testing simplified flows could improve activation by 25%.",
    priority: "medium",
    source: "AI Analysis",
    impact: 890,
    confidence: 72,
...
export default function DiscoverPage() {
  ...
  function handleStartExperiment(item: DiscoverItem) {
    ...
    // Navigate to validate hub with pre-filled experiment
  }
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-slate-500 mt-1">
              What should I work on next? AI-powered insights from across your product stack.
            </p>
          </div>
                            ...
                            <>
                              {item.type === "recommendation" && (
                                <ActionButton
                                  ...
                                  variant="primary"
                                  size="sm"
                                  onClick={() => handleStartExperiment(item)}
                                >
                                  Start Experiment
                                </ActionButton>
                              )}
                        ...
                        {item.data && (
                          <div className="flex items-center gap-4 text-xs">
                            ...
                            {item.data.change && (
                              <span className={cn(
                                "font-semibold",
                                item.data.change.startsWith("+") ? "text-red-600" : "text-green-600"
                              )}>
                                {item.data.change}
                              </span>
                            )}
